    ...
    >
      <div className="mb-2 flex items-center mt-[52px]">
        <span className="text-medium-grey text-heading-s ml-8">
          ALL BOARDS({boardsData.boards.length})
        </span>
      </div>
      ...
      <div className="pr-6 h-full flex flex-col justify-between">
        <div>
          ...
          <div
            className="h-12 group mb-2 flex flex-row w-full items-center pl-8 hover:cursor-pointer"
          ...
          >
            ...
            <p className="text-heading-m text-main-purple group-hover:text-main-purple-hover pl-4">
              + Create New Board
            </p>
          </div>
        </div>
