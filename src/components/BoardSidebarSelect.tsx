interface BoardSidebarSelectProps {
  boardId: number;
...
const BoardSidebarSelect = ({
  boardId,
  openedBoardId,
  boardName,
  setBoardId,
}: BoardSidebarSelectProps) => {
  return (
    <div
      className={`${
        openedBoardId === boardId ? "bg-main-purple" : ""
    ...
    >
      <svg
        className={`${
          openedBoardId === boardId ? "fill-white" : "fill-grey"
      ...
      <p
        className={`${
          openedBoardId === boardId ? "text-white" : "text-medium-grey"
...
export default BoardSidebarSelect;
